...
public class Situation {
	...
	public String toCSVFileHeightRandomShoot() {
		String res = "";//getCSVColumns()+"\n";
	...
	public String toCSVFileHeightRandomSee() {
		String res = "";//getCSVColumns()+"\n";
		
		res+=averageAltitude/compteur+","+minAltitude+","+maxAltitude+","+currentAltitude+","+fovValue+","+lastAction+","+impactProba;
